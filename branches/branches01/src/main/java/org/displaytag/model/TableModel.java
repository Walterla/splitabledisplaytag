...
public class TableModel
{
    ...
    public void setRowListFull(List rowListFull) {
    ...
    public Object clone(){
        ...
        TableModel tableModel = new TableModel(this.properties, this.encoding, this.pageContext);
        List headerCellList_copy = new ArrayList();
        headerCellList_copy.addAll(this.getHeaderCellList());
        tableModel.setHeaderCellList(headerCellList_copy);
        
        List rowListFull_copy = new ArrayList();
        rowListFull_copy.addAll(this.getRowListFull());
        tableModel.setRowListFull(rowListFull_copy);
        
        List rowListPage_copy = new ArrayList();
        rowListPage_copy.addAll(this.rowListPage);
        tableModel.setRowListPage(rowListPage_copy);
        
        tableModel.setSortedColumnName(this.sortedColumnName);
        tableModel.setSortOrderAscending(this.sortOrderAscending);
        tableModel.setSortFullTable(this.sortFullTable);
        tableModel.setTableDecorator(this.tableDecorator);
        tableModel.setId(this.id);
        tableModel.setPageOffset(this.pageOffset);
        tableModel.setLocalSort(this.localSort);
        tableModel.setCaption(this.caption);
        tableModel.setFooter(this.footer);
        tableModel.setMedia(this.media);
        tableModel.setForm(this.form);
        tableModel.setSortedColumnNumber(this.getSortedColumnNumber());
