  ...
  <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
    ...
    <body>
      ...
      <display:table name="requestScope.test" id="table">
        ...
        <display:column nulls="false" title="empty"><jsp:expression>((org.displaytag.test.KnownTypes)pageContext.getAttribute("table")).getNullValue()</jsp:expression></display:column>
