...
public class TitleKeyJstlFmtBundleTest extends DisplaytagCase
{
    ...
    public void doTest(String jspName) throws Exception
    {
        ...
        assertEquals("Header from resource is not valid.", "foo bundle", tables[0].getCellAsText(0, 0));
        assertEquals("Header from resource is not valid.", "baz bundle", tables[0].getCellAsText(0, 1));
        assertEquals("Header from resource is not valid.", "camel bundle", tables[0].getCellAsText(0, 2));
